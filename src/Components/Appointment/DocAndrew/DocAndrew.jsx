        ...
        <div className="col-12">
          <div className="appointment-page">
            ...
            <div className="appointment-page-text">
              ...
              <p>
                MBBS - Gastroenterologist{" "}
                <span className="appointment-page-span">7 Years</span>
              </p>
              <h6>
                About{" "}
                <img
              ...
              <p className="appointment-page-text-p">
                Dr. Andrew has a strong commitment to delivering comprehensive
