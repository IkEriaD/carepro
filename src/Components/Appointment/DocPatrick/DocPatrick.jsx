          ...
          <div className="appointment-page">
            ...
            <div className="appointment-page-text">
              ...
              <p className="appointment-page-text-p">
                Dr. Patrick has a strong commitment to delivering comprehensive
              ...
              <p className="appointment-fee-p">
                Appointment fee: <span className="appointment-fee-span">$25</span>{" "}
              </p>
            </div>
          </div>
